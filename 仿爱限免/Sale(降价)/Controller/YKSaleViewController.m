...
@interface YKSaleViewController ()<UISearchBarDelegate>

@property (nonatomic, assign) int currentPag;
@property (nonatomic, strong) NSMutableArray *saleStatusFrame;

@end

@implementation YKSaleViewController
...
- (void)loadMoreDatas {
    ...
    NSString *urlStr = [NSString stringWithFormat:SALES_URL, _currentPag];
